...
public class TCH_05_VerifyHotelsPriceLowToHigh extends BaseClass {
  ...
  // WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(60));
   ...
   Hotels_Page.getFlightsCount(Log, screenShots);
	...
	//Method for to validate result page hotel page is displaying or not 
		...
		Hotels_Page.ClickHotelsPriceLowToHigh();
		Hotels_Page.validateHotelsPriceLowToHigh(Log, screenShots);
