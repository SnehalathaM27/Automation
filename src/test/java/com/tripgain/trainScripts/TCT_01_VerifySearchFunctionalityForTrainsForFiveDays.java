...
public class TCT_01_VerifySearchFunctionalityForTrainsForFiveDays extends BaseClass {
...
Trains_Page.clickOnSearch();
   ...
   long endTime = System.currentTimeMillis();
    ...
    Thread.sleep(1000);
    Trains_Page.clcikArrivalTime(Log, screenShots, "After 6 PM");
    Thread.sleep(1000);
    Trains_Page.validateArrivalTimeAfter6PM(Log, screenShots);
    Thread.sleep(1000);
