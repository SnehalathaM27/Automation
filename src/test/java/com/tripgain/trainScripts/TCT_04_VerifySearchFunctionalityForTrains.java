...
public class TCT_04_VerifySearchFunctionalityForTrains extends BaseClass {
...
Trains_Page.clickOnSearch();
   ...
   long endTime = System.currentTimeMillis();
    ...
    Trains_Page.clickAvailableClasses(Log, screenShots, "AC 2 Tier (2A)");
    Thread.sleep(1000);
    Trains_Page.clcikDepartTime(Log, screenShots, "After 6 PM");
    Thread.sleep(1000);
    Trains_Page.validateDepartTimeAfter6PM(Log, screenShots);
    Thread.sleep(1000);
  ...
  Thread.sleep(1000);
  String[] selectedTierDetails =Trains_Page.selectTierAndGetPrice("AC 2 Tier (2A)", Log, screenShots);
