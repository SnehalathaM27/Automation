...
public class TCT_09_VerifySearchFunctionalityForTrains extends BaseClass {
...
Trains_Page.clickOnSearch();
   ...
   long endTime = System.currentTimeMillis();
    ...
    Trains_Page.clickAvailableClasses(Log, screenShots, "AC 3 Tier (3A)");
    Thread.sleep(2000);
  ...
  Thread.sleep(2000);
  String[] selectedTierDetails =Trains_Page.selectTierAndGetPrice("AC 3 Tier (3A)", Log, screenShots);
