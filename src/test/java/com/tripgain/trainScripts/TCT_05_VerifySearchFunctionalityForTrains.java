...
public class TCT_05_VerifySearchFunctionalityForTrains extends BaseClass {
...
Trains_Page.clickOnSearch();
   ...
   long endTime = System.currentTimeMillis();
    ...
    Trains_Page.clickAvailableClasses(Log, screenShots, "AC Chair Car (CC)");
    Thread.sleep(1000);
  ...
  Thread.sleep(1000);
  String[] selectedTierDetails =Trains_Page.selectTierAndGetPrice("AC Chair Car (CC)", Log, screenShots);
