...
public class TCT_06_VerifySearchFunctionalityForTrains extends BaseClass {
...
Trains_Page.clickOnSearch();
   ...
   long endTime = System.currentTimeMillis();
    ...
    Trains_Page.clickAvailableClasses(Log, screenShots, "Executive Chair Car (EC)");
    Thread.sleep(1000);
    Trains_Page.clcikDepartTime(Log, screenShots, "Before 6 AM");
    Thread.sleep(1000);
    Trains_Page.validateDepartTimeBefore6AM(Log, screenShots);
    Thread.sleep(1000);
    Trains_Page.clcikArrivalTime(Log, screenShots, "12 PM to 6 PM");
    Thread.sleep(1000);
    Trains_Page.validateArrivalTime12PMTo6PM(Log, screenShots);
  ...
  Thread.sleep(1000);
  String[] selectedTierDetails =Trains_Page.selectTierAndGetPrice("Executive Chair Car (EC)", Log, screenShots);
