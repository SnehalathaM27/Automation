...
public class TCT_03_VerifySearchFunctionalityForTrains extends BaseClass {
...
Trains_Page.clickOnSearch();
   ...
   long endTime = System.currentTimeMillis();
    ...
    Trains_Page.clickAvailableClasses(Log, screenShots, "AC First Class (1A)");
    Thread.sleep(1000);
  ...
  Thread.sleep(1000);
  String[] selectedTierDetails =Trains_Page.selectTierAndGetPrice("AC First Class (1A)", Log, screenShots);
