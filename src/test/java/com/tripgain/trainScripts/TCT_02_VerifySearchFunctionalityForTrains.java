...
public class TCT_02_VerifySearchFunctionalityForTrains extends BaseClass {
...
Trains_Page.clickOnSearch();
   ...
   long endTime = System.currentTimeMillis();
    ...
    Trains_Page.clickAvailableClasses(Log, screenShots, "Third AC Economy (3E)");
    Thread.sleep(1000);
    Trains_Page.clcikDepartTime(Log, screenShots, "6 AM to 12 PM");
    Thread.sleep(1000);
    Trains_Page.validateDepartTime6AMTo12PM(Log, screenShots);
    Thread.sleep(1000);
    Trains_Page.clcikArrivalTime(Log, screenShots, "Before 6 AM");
    Thread.sleep(1000);
    Trains_Page.validateArrivalTimeBefore6AM(Log, screenShots);
  ...
  Thread.sleep(1000);
  String[] selectedTierDetails =Trains_Page.selectTierAndGetPrice("Third AC Economy (3E)", Log, screenShots);
